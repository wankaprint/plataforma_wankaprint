                            ...
                            {orders.map((order) => (
                                <tr key={order.id} className="hover:bg-gray-50">
                                    ...
                                    <td className="px-6 py-4 space-y-2">
                                        {/* Storage Links - assuming we stored path, need to construct URL or use download */}
                                        {/* Simplification: Linking to bucket public URL or specific download handler */}
                                        {/* NOTE: If buckets are private, these links won't work without signed URLs. 
                           For MVP admin, let's assume valid access or use the bucket path structure.
                       */}
